...
(function(){
    const sliders = [...document.querySelectorAll(".conoce_body")]; //Los corchetes y los 3 puntos es para convertirlo en un array en vez de nodos
    ...
    const changePosition = (change)=>{
        const currentElement = document.querySelector(".conoce_body--show").dataset.id; //Obtener el elemento actual en el que estamos, esto a traves del data id
        ...
        sliders[Number(currentElement)-1].classList.remove("conoce_body--show"); //obtnemos el elemento actual y removemos la clase conoce_body--show
        ...
        sliders[value-1].classList.add("conoce_body--show");
